<script>
	...
	function defaultPlatforms() {
		return [
			...
			{ id: 'goodbay', name: 'Goodbay', tagline: 'Gestión de rentas vacacionales y hospitalidad', pricing: getDynamicPricing('goodbay', 'Desde $199/mes'), features: ['Listings de propiedades', 'Gestión de limpieza con verificación'], color: 'pink', cta_href: 'https://goodbay.redbroomsoftware.com?utm_source=rbs_website&utm_medium=plataformas' },
			...
			{ id: 'continua', name: 'Continua', tagline: 'Coordinación de donación de sangre', pricing: getDynamicPricing('continua', 'Gratis para donantes'), features: ['Alertas a donantes en tiempo real', 'Dashboard para hospitales y bancos de sangre'], color: 'red', cta_href: 'https://continua.redbroomsoftware.com?utm_source=rbs_website&utm_medium=plataformas' },
			{ id: 'colectiva', name: 'Colectiva', tagline: 'Pagos, escrow y gestión de capital', pricing: getDynamicPricing('colectiva', 'Desde $499/mes'), features: ['CoDi + SPEI en tiempo real', 'Escrow y gestión de equity'], color: 'purple', cta_href: 'https://colectiva.redbroomsoftware.com?utm_source=rbs_website&utm_medium=plataformas' }
		];
	}
